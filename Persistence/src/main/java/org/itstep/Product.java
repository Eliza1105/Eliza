...
import lombok.AllArgsConstructor;//конструктор, который принимает один параметр для каждого поля и инициализирует их с его помощью.
import lombok.Data;//автоматически доб геттеры сеттеры
import lombok.NoArgsConstructor;//пустой констр
